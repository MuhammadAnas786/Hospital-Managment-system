...
jFXButton1[i].setLayoutX(501.0);
        jFXButton1[i].setLayoutY(20.0);
        jFXButton1[i].setText("Make Bill");
        jFXButton1[i].setStyle(" -fx-text-fill: black; -fx-border-color: #1A4F86;");
        jFXButton1[i].getStyleClass().add("btnAdd");
        jFXButton1[i].getStylesheets().add("/hms/stylesheets.css");
        jFXButton1[i].addEventFilter(ActionEvent.ACTION, MakeBill);
        jFXButton1[i].setCursor(Cursor.HAND);
        ...
        pane[i].getChildren().add(jFXButton1[i]);
 ...
 EventHandler<ActionEvent> eventHandler=new EventHandler<ActionEvent>(){
          ...
          public void handle(ActionEvent event) {
             ...
             JFXButton buta=(JFXButton)event.getSource();
                 ...
                 Store.setAppointment(Integer.parseInt(lab.getText()));
 ...
 EventHandler<ActionEvent> MakeBill=new EventHandler<ActionEvent>(){
           @Override
          public void handle(ActionEvent event) {
 ...
 private void BillingWindow(ActionEvent event) {
             try {
                 Store.Current=Store.Selection.Add;
                 
             Node node = (Node) event.getSource();
                    Stage stage = (Stage) node.getScene().getWindow();
                    //stage.setMaximized(true);
                    stage.close();
                    Scene scene = new Scene(FXMLLoader.load(getClass().getResource("Bills.fxml")));
 ...
 private void EditWindow(ActionEvent event) {
             ...
             Node node = (Node) event.getSource();
                    ...
                    //stage.setMaximized(true);
                    stage.close();
                    Scene scene = new Scene(FXMLLoader.load(getClass().getResource("PForm.fxml")));
                    stage.setScene(scene);
                    stage.show();
