 ...
 EventHandler<ActionEvent> eventHandler=new EventHandler<ActionEvent>(){
          ...
          public void handle(ActionEvent event) {
             ...
             JFXButton buta=(JFXButton)event.getSource();
                 ...
                 Store.setRec(Integer.parseInt(lab.getText()));
  ...
  private void EditWindow(ActionEvent event) {
             try {
                  Store.ActiveEmployee=Store.Employee.Reception;
...
ResultSet res=con.createStatement().executeQuery("Select * from Receptionist");
if(res!=null){
   
  while( res.next() ) {
       if(!res.getString("doc_id").isEmpty())
       {
           int le=Integer.parseInt(res.getString("rec_id"));
